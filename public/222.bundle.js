(self["webpackChunkjob_requirement_search"] = self["webpackChunkjob_requirement_search"] || []).push([[222],{
...
var Middleware = __webpack_require__(9503);
// EXTERNAL MODULE: ./node_modules/stylis/src/Parser.js
var Parser = __webpack_require__(3716);
...
var identifierWithPointTracking = function identifierWithPointTracking(begin, points, index) {
  ...
  while (true) {
    previous = character;
    character = (0,Tokenizer/* peek */.se)(); // &\f

    if (previous === 38 && character === 12) {
      points[index] = 1;
    }

    if ((0,Tokenizer/* token */.Sh)(character)) {
      break;
    }
  ...
  return (0,Tokenizer/* slice */.di)(begin, Tokenizer/* position */.G1);
};
...
var toRules = function toRules(parsed, points) {
  ...
  do {
    switch ((0,Tokenizer/* token */.Sh)(character)) {
      case 0:
        // &\f
        if (character === 38 && (0,Tokenizer/* peek */.se)() === 12) {
        ...
        parsed[index] += identifierWithPointTracking(Tokenizer/* position */.G1 - 1, points, index);
        break;

      case 2:
        parsed[index] += (0,Tokenizer/* delimit */.Tb)(character);
        break;
      ...
      case 4:
        ...
        if (character === 44) {
          // colon
          parsed[++index] = (0,Tokenizer/* peek */.se)() === 58 ? '&\f' : '';
      ...
      default:
        parsed[index] += (0,Utility/* from */.HT)(character);
    }
  } while (character = (0,Tokenizer/* next */.K2)());

  return parsed;
};

var getRules = function getRules(value, points) {
  return (0,Tokenizer/* dealloc */.VF)(toRules((0,Tokenizer/* alloc */.c4)(value), points));
...
function prefix(value, length) {
  switch ((0,Utility/* hash */.tW)(value, length)) {
    ...
    case 5443:
      return Enum/* WEBKIT */.j + value + Enum.MS + 'flex-item-' + (0,Utility/* replace */.HC)(value, /flex-|-self/, '') + value;
    // align-content

    case 4675:
      return Enum/* WEBKIT */.j + value + Enum.MS + 'flex-line-pack' + (0,Utility/* replace */.HC)(value, /align-content|flex-|-self/, '') + value;
    // flex-shrink
    ...
    case 4765:
      ...
      if ((0,Utility/* strlen */.b2)(value) - 1 - length > 6) switch ((0,Utility/* charat */.wN)(value, length + 1)) {
        // (m)ax-content, (m)in-content
        case 109:
          // -
          if ((0,Utility/* charat */.wN)(value, length + 4) !== 45) break;
        ...
        case 115:
          return ~(0,Utility/* indexof */.K5)(value, 'stretch') ? prefix((0,Utility/* replace */.HC)(value, 'stretch', 'fill-available'), length) + value : value;
      }
      break;
    // position: sticky
    ...
    case 4949:
      // (s)ticky?
      if ((0,Utility/* charat */.wN)(value, length + 1) !== 115) break;
    // display: (flex|inline-flex)

    case 6444:
      switch ((0,Utility/* charat */.wN)(value, (0,Utility/* strlen */.b2)(value) - 3 - (~(0,Utility/* indexof */.K5)(value, '!important') && 10))) {
        // stic(k)y
        case 107:
        ...
        case 101:
          return (0,Utility/* replace */.HC)(value, /(.+:)([^;!]+)(;|!.+)?/, '$1' + Enum/* WEBKIT */.j + ((0,Utility/* charat */.wN)(value, 14) === 45 ? 'inline-' : '') + 'box$3' + '$1' + Enum/* WEBKIT */.j + '$2$3' + '$1' + Enum.MS + '$2box$3') + value;
      }
...
var prefixer = function prefixer(element, index, children, callback) {
  if (element.length > -1) if (!element["return"]) switch (element.type) {
    case Enum/* DECLARATION */.LU:
      element["return"] = prefix(element.value, element.length);
      break;

    case Enum/* KEYFRAMES */.Sv:
      return (0,Serializer/* serialize */.l)([(0,Tokenizer/* copy */.C)(element, {
        value: (0,Utility/* replace */.HC)(element.value, '@', '@' + Enum/* WEBKIT */.j)
      })], callback);

    case Enum/* RULESET */.XZ:
      if (element.length) return (0,Utility/* combine */.kg)(element.props, function (value) {
        switch ((0,Utility/* match */.YW)(value, /(::plac\w+|:read-\w+)/)) {
          // :read-(only|write)
          case ':read-only':
          case ':read-write':
            return (0,Serializer/* serialize */.l)([(0,Tokenizer/* copy */.C)(element, {
              props: [(0,Utility/* replace */.HC)(value, /:(read-\w+)/, ':' + Enum/* MOZ */.vd + '$1')]
            })], callback);
          // :placeholder

          case '::placeholder':
            return (0,Serializer/* serialize */.l)([(0,Tokenizer/* copy */.C)(element, {
              props: [(0,Utility/* replace */.HC)(value, /:(plac\w+)/, ':' + Enum/* WEBKIT */.j + 'input-$1')]
            }), (0,Tokenizer/* copy */.C)(element, {
              props: [(0,Utility/* replace */.HC)(value, /:(plac\w+)/, ':' + Enum/* MOZ */.vd + '$1')]
            }), (0,Tokenizer/* copy */.C)(element, {
              props: [(0,Utility/* replace */.HC)(value, /:(plac\w+)/, Enum.MS + 'input-$1')]
            })], callback);
        }
...
var createCache = function createCache(options) {
  ...
  {
    var currentSheet;
    var finalizingPlugins = [Serializer/* stringify */.A,  false ? 0 : (0,Middleware/* rulesheet */.MY)(function (rule) {
      currentSheet.insert(rule);
    })];
    var serializer = (0,Middleware/* middleware */.r1)(omnipresentPlugins.concat(stylisPlugins, finalizingPlugins));

    var stylis = function stylis(styles) {
      return (0,Serializer/* serialize */.l)((0,Parser/* compile */.wE)(styles), serializer);
    };
...
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6319);
...
/* harmony import */ var _emotion_serialize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3451);
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6319);
